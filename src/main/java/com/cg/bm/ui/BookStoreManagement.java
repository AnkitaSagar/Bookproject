...
import com.cg.bm.model.BookMenu;
import com.cg.bm.service.BookService;
import com.cg.bm.service.IBookService;
...
public class BookStoreManagement {
	...
	public static void main(String[] args) {
		...
		while (menu != BookMenu.QUIT) {

			System.out.println("Choice\tMenu Item");
			System.out.println("===========================");
			for (BookMenu m : BookMenu.values()) {
			...
			if (choice < 0 || choice >= BookMenu.values().length) {
				System.out.println("Invalid Choice");
			} 
			else {
				menu = BookMenu.values()[choice];
				switch (menu) {
				case ADD:
					doAdd();
					break;
